export default {
  ...
  'hardware-rendering-hint': 'เพื่อความเข้ากันได้กับไดรเวอร์ GPU Linux มากขึ้น จึงใช้การเรนเดอร์ซอฟต์แวร์เป็นค่าเริ่มต้น การเปิดใช้งานจะเปิดการเร่งความเร็วฮาร์ดแวร์ DMA-BUF เพื่อ UI ที่ลื่นไหลขึ้น แต่อาจทำให้หน้าจอขาวหรือแครชกับ GPU บางตัว (เช่น NVIDIA proprietary, Intel + Wayland, Raspberry Pi) หากแอปแครชหลังเปิดใช้งาน จะถูกปิดอัตโนมัติในการเปิดครั้งถัดไป',
  'hardware-rendering-restart-confirm': 'การเร่งความเร็ว GPU ใช้ WebKitGTK DMA-BUF renderer ซึ่งต้องกำหนดค่าก่อนเริ่มกระบวนการ ดังนั้นการเปลี่ยนแปลงนี้ต้องรีสตาร์ท หากการเปิดใช้งานทำให้แอปไม่สามารถเริ่มต้นได้ตามปกติ ตัวเลือกนี้จะถูกปิดอัตโนมัติในการเปิดครั้งถัดไป งานดาวน์โหลดของคุณจะไม่ได้รับผลกระทบ',
