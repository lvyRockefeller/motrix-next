export default {
  ...
  'hardware-rendering-hint': 'لتوافق أفضل مع تعريفات Linux، يُستخدم العرض البرمجي افتراضيًا. التفعيل يُمكّن تسريع DMA-BUF لتحسين سلاسة الواجهة، لكن قد يسبب شاشة بيضاء أو توقف مفاجئ مع بعض البطاقات (مثل تعريفات NVIDIA المغلقة، Intel + Wayland، Raspberry Pi). إذا تعطل التطبيق بعد التفعيل، سيتم إيقافه تلقائيًا في التشغيل التالي.',
  'hardware-rendering-restart-confirm': 'يستخدم تسريع GPU عارض WebKitGTK DMA-BUF الذي يجب تكوينه قبل بدء العملية، لذا يتطلب هذا التغيير إعادة التشغيل. إذا منع التفعيل التطبيق من البدء بشكل طبيعي، سيتم إيقاف هذا الخيار تلقائيًا في التشغيل التالي. لن تتأثر مهام التنزيل.',
