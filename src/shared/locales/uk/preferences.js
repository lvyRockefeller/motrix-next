export default {
  ...
  'hardware-rendering-hint': 'Для сумісності з більшою кількістю GPU-драйверів Linux за замовчуванням використовується програмний рендеринг. Увімкнення активує апаратне прискорення DMA-BUF для плавнішого інтерфейсу, але може спричинити білий екран або збій на деяких GPU (напр. пропрієтарні NVIDIA, Intel + Wayland, Raspberry Pi). Якщо програма аварійно завершиться після увімкнення, параметр буде автоматично вимкнено при наступному запуску.',
  'hardware-rendering-restart-confirm': 'Апаратне прискорення GPU використовує рендерер WebKitGTK DMA-BUF, який повинен бути налаштований до запуску процесу, тому ця зміна потребує перезапуску. Якщо увімкнення перешкоджає нормальному запуску програми, цей параметр буде автоматично вимкнено при наступному запуску. Ваші завдання завантаження не будуть зачеплені.',
