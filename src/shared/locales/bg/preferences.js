export default {
  ...
  'hardware-rendering-hint': 'За съвместимост с повече Linux GPU драйвери по подразбиране се използва софтуерно рендериране. Включването активира DMA-BUF хардуерно ускорение за по-плавен интерфейс, но може да причини бял екран или срив при някои GPU (напр. NVIDIA собствен драйвер, Intel + Wayland, Raspberry Pi). Ако приложението се срине след включване, ще се изключи автоматично при следващото стартиране.',
  'hardware-rendering-restart-confirm': 'GPU ускорението използва WebKitGTK DMA-BUF рендерер, който трябва да се конфигурира преди стартиране на процеса, затова тази промяна изисква рестартиране. Ако активирането попречи на нормалното стартиране, тази опция ще бъде автоматично изключена при следващото стартиране. Задачите за изтегляне няма да бъдат засегнати.',
