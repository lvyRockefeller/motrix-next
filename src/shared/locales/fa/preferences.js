export default {
  ...
  'hardware-rendering-hint': 'برای سازگاری بیشتر با درایورهای GPU لینوکس، به‌طور پیش‌فرض از رندر نرم‌افزاری استفاده می‌شود. فعال‌سازی، شتاب‌دهی سخت‌افزاری DMA-BUF را برای رابط کاربری روان‌تر فعال می‌کند، اما ممکن است با برخی GPU‌ها (مانند درایور اختصاصی NVIDIA، Intel + Wayland، Raspberry Pi) صفحه سفید یا خرابی ایجاد کند. اگر برنامه پس از فعال‌سازی خراب شود، در راه‌اندازی بعدی خودکار غیرفعال خواهد شد.',
  'hardware-rendering-restart-confirm': 'شتاب‌دهی GPU از رندرر WebKitGTK DMA-BUF استفاده می‌کند که باید قبل از شروع فرآیند پیکربندی شود، بنابراین این تغییر نیاز به راه‌اندازی مجدد دارد. اگر فعال‌سازی مانع شروع عادی برنامه شود، این گزینه در راه‌اندازی بعدی خودکار غیرفعال خواهد شد. وظایف دانلود شما تحت تأثیر قرار نخواهند گرفت.',
