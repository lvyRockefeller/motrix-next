export default {
  ...
  'hardware-rendering-hint': 'Για συμβατότητα με περισσότερους οδηγούς GPU Linux, χρησιμοποιείται λογισμικό rendering από προεπιλογή. Η ενεργοποίηση επιτρέπει την επιτάχυνση DMA-BUF για πιο ομαλή διεπαφή, αλλά μπορεί να προκαλέσει λευκή οθόνη ή κατάρρευση σε ορισμένες GPU (π.χ. ιδιόκτητοι οδηγοί NVIDIA, Intel + Wayland, Raspberry Pi). Αν η εφαρμογή καταρρεύσει μετά την ενεργοποίηση, θα απενεργοποιηθεί αυτόματα στην επόμενη εκκίνηση.',
  'hardware-rendering-restart-confirm': 'Η επιτάχυνση GPU χρησιμοποιεί τον WebKitGTK DMA-BUF renderer, ο οποίος πρέπει να ρυθμιστεί πριν από την εκκίνηση της διεργασίας, επομένως αυτή η αλλαγή απαιτεί επανεκκίνηση. Αν η ενεργοποίηση εμποδίσει την κανονική εκκίνηση, αυτή η επιλογή θα απενεργοποιηθεί αυτόματα στην επόμενη εκκίνηση. Οι εργασίες λήψης δεν θα επηρεαστούν.',
